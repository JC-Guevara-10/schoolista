              ...
              <Card className="bg-blue-50 border-blue-200">
                ...
                <CardContent>
                  <ul className="space-y-2 text-sm text-blue-800">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-blue-600 mt-0.5">•</span>
<<<<<<< HEAD:app/(front-end)/(private)/evaluation/components/admin-dashboard.tsx
...
>>>>>>> d5af7d7ad70d9aabc3b146683d0a3e5b01db993b:app/(front-end)/(private)/faculty-evaluation/components/admin/admin-dashboard.tsx
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-blue-600 mt-0.5">•</span>
